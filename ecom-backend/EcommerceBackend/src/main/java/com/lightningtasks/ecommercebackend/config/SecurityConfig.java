...
import com.lightningtasks.ecommercebackend.authorization.CustomAuthorizationManager;
import com.lightningtasks.ecommercebackend.filters.JwtAuthenticationFilter;
...
//    public GrantedAuthority userAuthority() {
 ...
 //   }
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://217.15.170.145"));
